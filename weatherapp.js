...
var _this = this;
var api_key = "aa0138bac187af0a3cc531d2f8680e29";
...
var displayWeather = function (data) {
    var name = data.name, main = data.main;
    var temperature = (main.temp).toFixed(0);
    resultContainer.innerHTML = "\n        <h2>Weather in ".concat(name, "</h2>\n        <p>Temperature: ").concat(temperature, "\u00B0C</p>\n    ");
    if (!temperature) {
        container.classList.remove("container-fluid");
    }
    else if (parseInt(temperature) < 16) {
